...
public class EmployeeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (action!=null){
            ...
            case "searchById":
                ...
                break;           
            case "searchByName":
            	String apiUrl = req.getParameter("employeeName");
            	restcallservice(req,resp,apiUrl); //2 = GET
                //searchEmployeeByName(req, resp);
                break;
            case "restCall":
            //	restcallservice(req,resp,2); //2 = GET
            	//forwardListEmployees(req,resp);
                break;
            }
        }else{
    ...
    private void forwardListEmployees(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        switch (action) {
            ...
            case "remove":
                ...
                break; 
            case "restCall":
            	//restcallservice(req,resp,1); //1 = POST
            	//forwardListEmployees(req,resp);
    ...
    private void restcallservice(HttpServletRequest req, HttpServletResponse resp, String paramApiUrl)
    	...
    	boolean success = employeeService.sendrequest(paramApiUrl);
        String message = null;
        if (success) {
            message = "REST CALL SUCCESSFULLY MADE";
        }
        else{
        	message = "ERROR IN REST CALL ";
        }
